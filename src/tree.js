    ...
    function ddlnode( lineNo, inputLine, parent ) {
        ...
        this.parseType = function( pure ) {
            ...
            if( 0 < this.indexOf('pk') ) {
                ...
                if( ret.startsWith('number') && ddl.optionEQvalue('pk', ddl.identityDataType) )
        ...
        this.toDDL = function(  ) {
            ...
            if( idColName != null ) {
                let typeModifier = 'not null';
                if( ddl.optionEQvalue('pk', ddl.identityDataType) )
                    typeModifier = 'GENERATED BY DEFAULT ON NULL AS IDENTITY'.toLowerCase();
...
`           ;}
    ...
    function recognize( ddlInstance, fullInput ) {
        ddl = ddlInstance;
    ...
    function setOptions( line ) {
        ...
        for( let x in settings ) {
            if( ddl.getOptionValue(x) == null ) {
                ddl.unknownSettings.push(x);
                continue;
            }
